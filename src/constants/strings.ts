...
export const QUEUE_LAUNCH_PIPELINE = '\u25B6 Launch pipeline';
export const QUEUE_LAUNCH_PIPELINE_TITLE = 'Launch all phases sequentially \u2014 each phase waits for the previous to complete';
export const QUEUE_STOP_PIPELINE = '\u25A0 Stop pipeline';
export const QUEUE_STOP_PIPELINE_TITLE = 'Stop launching new phases (running tasks will finish)';
export const QUEUE_PIPELINE_PHASE = 'Phase';
...
export const RELEASE_BUMP_MAJOR = 'Major';
export const RELEASE_BUMP_MINOR = 'Minor';
export const RELEASE_BUMP_PATCH = 'Patch';
