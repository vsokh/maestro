...
export function App() {
  ...
  const actions = useMemo(() => ({
    ...
    handleLaunchPipeline: queueActions.handleLaunchPipeline,
    cancelPipeline: queueActions.cancelPipeline,
    ...
    pipelineRunning: queueActions.pipelineRunning,
    pipelinePhase: queueActions.pipelinePhase,
    // Project actions
    pauseTask,
    cancelTask,
    // Selection
